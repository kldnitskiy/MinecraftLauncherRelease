...
let counter = 0;
//function copyAuth(){
//        fs.copyFile('bin/authlib-1.5.25.jar', 'bin/minecraft/libraries/com/mojang/authlib/1.5.25//authlib-1.5.25.jar', (err) => {
//  if (err) throw err;
//  console.log('auth was installed');
//});
//}
function copyAuth(){
        fs.copyFile('resources/app/bin/authlib-1.5.25.jar', 'resources/app/bin/minecraft/libraries/com/mojang/authlib/1.5.25//authlib-1.5.25.jar', (err) => {
  if (err) throw err;
  console.log('auth was installed');
});
}
